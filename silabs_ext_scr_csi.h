/*
 * silabs_ext_scr_csi.h — Silicon Labs GSDK port of ext_scr_csi.h
 * Ported from Nordic nRF / Zephyr nCS v2.8.0
 * Target: EFR32 / CMSIS-RTOS2
 *
 * Generated by tools/make_silabs_port.py — do NOT merge back to ext_scr_csi.h
 *
 * Platform notes: This header is platform-agnostic (pure ISO C enums + macros).
 * No Zephyr / MPSL / Nordic-specific dependencies — copied verbatim.
 */
